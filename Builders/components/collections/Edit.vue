                    ...
                    <div class="px-4 sm:px-6">
                      <div class="items-start justify-between">
                        ...
                        <div class="mt-6 py-6">
                          ...
                          <label />Phone Number
                          <input
                            v-model="prefillData.phone_number"
                            type="text"
                            class="p-4 block mb-3 w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-300 sm:py-1.5 sm:text-sm sm:leading-6"
                          />
                          <label />Established Year
                          <input
                            v-model="prefillData.established_year"
                            type="text"
                            class="p-4 block mb-3 w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-300 sm:py-1.5 sm:text-sm sm:leading-6"
                          />
                          <label />Tag Line
                          <input
                            v-model="prefillData.tag_line"
                            type="text"
                            class="p-4 block mb-3 w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-300 sm:py-1.5 sm:text-sm sm:leading-6"
                          />
                        </div>
...
const open = ref(true);
//Declaring the emits
const emit = defineEmits(["builderEditBody"]);

//Sending body through the emit
const builderEditSaveCall = async () => {
  emit("builderEditBody", props.prefillData);
};
</script>
