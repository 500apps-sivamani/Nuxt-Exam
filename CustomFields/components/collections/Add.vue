...
let customName = ref("");
let customType = ref("");
let customDescription = ref("");
let customPlaceholder = ref("");

const open = ref(true);

//Declaring the emits
const emit = defineEmits(["customPostBody"]);

//Sending body through the emit
const customfieldSavecall = async () => {
  let body = {
